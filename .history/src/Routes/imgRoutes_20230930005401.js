...
import { createImg, deleteImg, getImg, getImgById, getImgByUserId, updateImg, upload, uploadImg } from '../Controllers/imgController';


const imgRoutes = express.Router();

    imgRoutes.get('/get-img', getImg);
    imgRoutes.get("/get-image/:imageId", getImgById);
    imgRoutes.get('/get-img-by-user-id', authenticateJWT, getImgByUserId);
